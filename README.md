# nvim-treesitter-queries-gstlaunch

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gstlaunch/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gstlaunch/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gstlaunch**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gstlaunch",
...
- [ ] Changes are scoped to `gstlaunch` — do not include files for other languages
